...
namespace Approximation{
    ...
    public:
        ...
        DerivativeObservation(std::shared_ptr<muq::Utilities::LinearOperator> Hin,
                              ...
                              unsigned                                        derivCoord) : DerivativeObservation(Hin, locIn, obsIn, obsCovIn, std::vector<unsigned>(1,derivCoord)) {};
        ...
        DerivativeObservation(std::shared_ptr<muq::Utilities::LinearOperator> Hin,
                              ...
                              Eigen::Ref<const Eigen::VectorXd> const&        obsIn,
                              Eigen::Ref<const Eigen::MatrixXd> const&        obsCovIn,
                              std::vector<unsigned>                           derivCoordsIn) : ObservationInformation(Hin, locIn, obsIn, obsCovIn), derivCoords(derivCoordsIn){};
        ...
        std::vector<unsigned> derivCoords;
