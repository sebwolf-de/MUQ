...
\f]
The constructor of this class uses the Nystrom method to approximately solve for \f$\lambda_k\f$ and \f$e_k(x)\f$.  The method starts with a set of \f$N\f$ seed points \f$x_i\f$ and a set of weights \f$w_i\f$ that satisfy
\f[
