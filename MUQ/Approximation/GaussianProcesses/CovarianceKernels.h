...
void FillKernelVector(std::vector<std::shared_ptr<KernelBase>> & vec, KernelBase const& kernel1)
{
    vec.push_back(kernel1.Clone());
}
...
*/
template<typename... KTypes>
CoregionalKernel CoregionTie(Eigen::MatrixXd const& coCov, const KernelBase& kernel1, const KernelBase& kernel2, const KTypes&... kernels)
{
...
CoregionalKernel CoregionTie(Eigen::MatrixXd const& coCov, KernelBase const& kernel1, int numRepeat)
{
