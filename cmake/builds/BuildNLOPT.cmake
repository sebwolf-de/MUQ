...
ExternalProject_Add(
  NLOPT
    ...
    CONFIGURE_COMMAND CC=${CMAKE_C_COMPILER} CXX=${MUQ_CXX_COMPILER}; ${CMAKE_CURRENT_BINARY_DIR}/external/nlopt/src/NLOPT/configure  CC=${CMAKE_C_COMPILER} CXX=${MUQ_CXX_COMPILER} ${HDF5_PARALLEL_FLAG} --prefix=${NLOPT_INSTALL_DIR} --enable-shared
