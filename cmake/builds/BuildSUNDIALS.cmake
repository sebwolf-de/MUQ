...
ExternalProject_Add(
	SUNDIALS
				...
				CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${SUNDIALS_INSTALL_DIR} -DCMAKE_C_COMPILER=${CMAKE_C_COMPILER} -DCMAKE_CXX_COMPILER=${MUQ_CXX_COMPILER} -DMPI_ENABLE=ON -DBUILD_CVODE=OFF -DBUILD_CVODES=ON -DBUILD_IDA=OFF -DBUILD_IDAS=ON -DBUILD_KINSOL=ON -DBUILD_SHARED_LIBS=ON -DBUILD_STATIC_LIBS=ON
