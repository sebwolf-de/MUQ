...
IF(MUQ_USE_GTEST)
    ...
    message("MUQ_LINK_LIBS = ${${CMAKE_PROJECT_NAME}_LINK_LIBS} ${${CMAKE_PROJECT_NAME}_LIBRARIES}")
    TARGET_LINK_LIBRARIES(RunAllTests ${${CMAKE_PROJECT_NAME}_LIBRARIES} ${${CMAKE_PROJECT_NAME}_LINK_LIBS} ${GTEST_LIBRARY})
