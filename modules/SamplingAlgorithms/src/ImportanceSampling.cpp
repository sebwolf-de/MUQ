...
std::shared_ptr<TransitionKernel> ImportanceSampling::ConstructKernel(boost::property_tree::ptree& pt, std::shared_ptr<SamplingProblem> problem) const {
  // we have to use the importance sample transition kernel
  pt.put<std::string>("SamplingAlgorithm.TransitionKernel", "ISKernel");
