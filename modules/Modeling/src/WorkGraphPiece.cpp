...
WorkGraphPiece::WorkGraphPiece(std::shared_ptr<const Graph> graph,
                               ...
                               std::shared_ptr<WorkPiece> outputPiece,
                               std::shared_ptr<const AnyAlgebra> algebra) : WorkPiece(inTypes, constantPieces.size(), outputPiece->OutputTypes(), outputPiece->numOutputs), graph(graph), outputID(outputPiece->ID()), constantPieces(constantPieces), algebra(algebra) {
